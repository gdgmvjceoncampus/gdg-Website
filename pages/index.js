...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>GDG MVJCE</title>
        <meta
          name="description"
          content="Join GDG MVJCE, a hub for tech enthusiasts! Explore workshops, events, and projects. Dive into coding, AI, web development, and more."
        />
        <meta
          name="keywords"
          content="GDG MVJCE, Google Developer Group, MVJ College of Engineering, tech workshops, coding events, AI projects, web development, tech enthusiasts"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="GDG MVJCE" />
        <meta
